...
L["Name:"] = true
L["Undo what you deleted and access special actions for the tab"] = true
...
L["a normal 'To-Do List' button"] = true
...
L["hyperlinks"] = true
L["the item cannot be deleted"] = true
L["(toggle the edit mode to do so)"] = true
L["(empty the description if you want to do so)"] = true
