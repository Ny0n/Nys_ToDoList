...
L["favorites"] = "즐겨찾기"
L["Go to the addon options in the Blizzard interface panel to customize this."] = "블리자드 인터페이스 애드온 설정창에서 커스터마이징 하세요."
...
L["help"] = "도움"
L["Here are a few commands to help you understand some systems in the list:"] = "채팅 메세지"
...
L["show/hide the list"] = "항목 보기/숨김"
L["shows more information"] = "정보 더 보기"
...
L["To add a new item to a category, just right click the category name!"] = "카테고리에 할일을 추가하고 싶다면, 카테고리명을 우클릭하세요."
...
L["You can also left click on the category names to expand or shrink their content."] = "카테고리명을 클릭하면 목록을 늘이거나 줄일 수 있습니다."
...
L["Enable or disable the chat warning/reminder for favorite items"] = "즐겨찾기 할일 경고 및 알림 활성화 / 비활성화"
...
L["Show favorites warning"] = "즐겨찾기 경보 표시"
